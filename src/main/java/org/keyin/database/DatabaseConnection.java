...
public class DatabaseConnection {
    ...
    private static final String URL = "jdbc:postgresql://localhost:5432/ithelpdesksystem";
//    By default the username is postgres and the password is whatever you set it to be. I usually keep mine simple
